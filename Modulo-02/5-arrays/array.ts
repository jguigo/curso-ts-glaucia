...
let frutas: string[] = ['morango', 'abacaxi', 'maçã', 'uva'];
console.log(frutas[2]);

// => Exemplo 02 - Array Objetct (Objeto Array):
let frutas1: Array<string> = ['morango', 'abacaxi', 'maçã', 'uva'];
console.log(frutas[3]);

// => Exemplo 03 - Adicionando mais strings com método 'push'
let idiomas: Array<string> = ['Português', 'Ingles', 'Francês', 'Espanhol']
console.log(idiomas);
...
let idiomas1: Array<string> = ['morango', 'abacaxi', 'maçã', 'uva'];
