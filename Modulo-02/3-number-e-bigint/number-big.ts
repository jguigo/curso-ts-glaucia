...
let big1: bigint = 90000004758456445665465456n;
let big2: bigint = 0b00000000000000000000000000000000000000000000000000000000000001n;
let big3: bigint = 0x200000000003n;
let big4: bigint = 0o400000000000000000000003n;
